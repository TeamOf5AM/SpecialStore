...
@section('container')
    ...
    @endif                     
    <h1 class="mb10">Home Slider Banners</h1>
    ...
    <h1 class="mb10">Home Screen Banners</h1>
    <a href="{{url('admin/home_banner/manage_home_banner')}}">
        <button type="button" class="btn btn-success">
    ...
    <h1 class="mb10">Home Category Banners</h1>
    <a href="{{url('admin/home_banner/manage_home_banner')}}">
        <button type="button" class="btn btn-success">
            Add Home Category Banner
        </button>
    </a>
    <div class="row m-t-30">
        <div class="col-md-12">
