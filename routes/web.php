...
Route::get('/solar-calculator',[FrontController::class,'solar_calculator']);
...
Route::get('prod_search',[FrontController::class,'prod_search']);
Route::get('registration',[FrontController::class,'registration']);
Route::post('contact_form',[FrontController::class,'contact_form']);
